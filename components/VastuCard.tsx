      ...
      >
        <div className="flex items-center gap-4 flex-1">
          <div className="relative w-16 h-16 rounded-full border border-gold/40 overflow-hidden shrink-0">
            ...
            <img src="/vastu.png" alt="" className="w-full h-full object-cover" />
          </div>
          <div className="flex-1 pr-2">
            <h3 className="text-lg font-display text-gold mb-1 leading-tight">{t("home.vastu")}</h3>
            <p className="text-xs text-muted leading-relaxed">{t("home.vastuDesc")}</p>
          </div>
        </div>
