...
/**
 * Shared bottom-sheet shell (backdrop, spring-in sheet, sticky header with a
 * content slot, scrollable body, close button, bottom safe-area padding).
 * Extracted from ForecastDetailModal/MonthlyBreakdownModal, which duplicated
 * this markup almost verbatim — see
 * docs/superpowers/plans/2026-07-03-horoscope-category-ratings-plan.md Task 8.
 */
