 ...
 *
 * ─────────────────────────────────────────────────────────────────────────
 * MIRRORED IN THE LANDING REPO at landing/src/lib/legal-content.ts, which
 * renders the public arohaastrology.in/legal/* pages (the URLs the Play
 * Store listing and the backend's GET /legal/current point at). The two are
 * separate git repos with no shared CI, so nothing enforces this: EDIT THIS
 * FILE FIRST, then copy it across. LEGAL_VERSION must match in both, and in
 * jyotish-backend/src/modules/legal/legal.routes.ts.
 * ─────────────────────────────────────────────────────────────────────────
 */
